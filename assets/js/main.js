class Produto {
    ...
    preparaEdicao(dadosProdutos) {
        ...
        inputPreco.setAttribute("onkeyup", "produto.salvarComEnter(event, " + JSON.stringify(dadosProdutos) + "); produto.closeInfoErroNome()");
    ...
    atualizarProduto(dadosProdutos) {
        ...
        if (valorProduto != '') {
            ...
            let precoProdutoInvalido = document.querySelector('#preco_invalido');
            precoProdutoInvalido.innerHTML = 'O preço do produto deve ser informado!';
            precoProdutoInvalido.style.display = 'block'
        }
    ...
    salvarComEnter(e, dadosProdutos) {
        if (this.editItem == false) {
            if (e.keyCode == 13) {
                this.salvar();
            }
            ...
            if (e.keyCode == 13) {
                this.atualizarProduto(dadosProdutos);
            }
        }
    }
}
